                                    ...
                                    <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="pages">
                                                <li><a href="productoslista.jsp.jsp" class="dropdown-item">Administracion </a></li>
            ...
            <div class="col-md-12">
                <div class="category-carousel swiper">
                    <div class="swiper-wrapper">
                        <a href="index.jsp" class="nav-link category-item swiper-slide">
                            <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                            <h3 class="category-title">Postres Veganos</h3>
                        </a>
                        <a href="index.jsp" class="nav-link category-item swiper-slide">
                            <img src="images/icon-bread-baguette.png" alt="Category Thumbnail">
                            <h3 class="category-title">Panaderia</h3>
                        </a>
                        <a href="index.jsp" class="nav-link category-item swiper-slide">
                        ...
                        <a href="index.jsp" class="nav-link category-item swiper-slide">
                            <img src="images/icon-bread-herb-flour.png" alt="Category Thumbnail">
                                    <h3 class="category-title">Infuciones</h3>
                        </a>
                    </div>
                </div>
            </div>

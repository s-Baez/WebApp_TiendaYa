        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
              ...
              <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="dropdown-list-image mr-3">
                  <img class="rounded-circle" src="imges/undraw_profile_2.svg"
                       alt="...">
        ...
        <div class="container mt-5" style="max-width: 600px;">
          <div class="card shadow">
            <div class="card-header" style="background-color: #FFA25B; color: white;">
              <h4 class="m-0">Registrar Proveedor</h4>
            </div>
            <div class="card-body">
              <form action="RegistrarProveedorControl" method="post">
                ...
                <button type="submit" class="btn btn-block" style="background-color: #FFA25B; color: white;">Registrar Proveedor</button>
              </form>
            </div>
          </div>
        </div>
